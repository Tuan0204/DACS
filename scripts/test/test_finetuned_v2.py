...
# Load fine-tuned model (aggressive, 20 epochs)
print("\nLOADING FINE-TUNED MODEL (aggressive)...")
ckpt_finetuned = load_checkpoint('models/mobilenetv3/best_model_finetuned_20260511_004429.pt')
...
if pred_ft == 2 and conf_ft > 0.5:
    print("\n✅ SUCCESS! Northern Leaf Blight now correctly predicted!")
else:
    print(f"\n⚠️  Still predicted as {class_names[pred_ft]} ({conf_ft:.1%})")
